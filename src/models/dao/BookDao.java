...
public class BookDao {
    ...
    public static boolean create(@NotNull Book book) throws SQLException {
    ...
    public static boolean update(@NotNull Book book) throws SQLException {
    ...
    public static boolean delete(@NotNull Book book) throws SQLException {
